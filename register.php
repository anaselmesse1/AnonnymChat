...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $checkStmt = $conn->prepare("SELECT id FROM allusers WHERE username = ?");
    ...
    if ($checkStmt->num_rows > 0) {
        ...
        $error = "Username is not available, please try another one.";
    } else {
        // Insert new user
        $insertStmt = $conn->prepare("INSERT INTO allusers (username, password) VALUES (?, ?)");
...
<html>
  <meta charset="UTF-8">
    ...
    <title>AnonnymChat - Join Us</title><link rel="stylesheet" href="all.css">
    ...
    <div class="container">
        ...
        <div class="mascot-side">
            ...
            <div class="mascot-container">
                ...
                <div class="speech-bubble">
                    <p>Welcome! I'm here to protect your anonymity while you chat. Join our secure network today!</p>
                </div>
            </div>
        </div>
        ...
        <div class="form-side">
            ...
            <div class="form-header">
                <h1>AnonnymChat</h1>
                <p>Create your anonymous identity</p>
            </div>
